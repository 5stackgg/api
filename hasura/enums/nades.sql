insert into e_nade_visibility ("value", "description") values
...
insert into e_nade_techniques ("value", "description") values
...
insert into e_nade_throw_strengths ("value", "description") values
    ('Full', 'Left click'),
    ('Half', 'Left and right click together'),
    ('Drop', 'Right click')
on conflict(value) do update set "description" = EXCLUDED."description";

insert into e_nade_sources ("value", "description") values
    ('plugin', 'Recorded in game by the nade practice plugin'),
...
insert into e_nade_practice_statuses ("value", "description") values
