...
SELECT
  ...
  SUM(s.he_team_damage)::integer       AS he_team_damage,
  ...
  SUM(s.traded_death_attempts)::integer      AS traded_death_attempts,
  ...
  SUM(s.hs_kills_ct)::integer                       AS hs_kills_ct,
  SUM(s.deaths_t)::integer                          AS deaths_t,
  SUM(s.deaths_ct)::integer                         AS deaths_ct,
  SUM(s.damage_t)::integer                          AS damage_t,
  SUM(s.damage_ct)::integer                         AS damage_ct,
  SUM(s.assists_t)::integer                         AS assists_t,
  SUM(s.assists_ct)::integer                        AS assists_ct,
  SUM(s.rounds_t)::integer                          AS rounds_t,
  SUM(s.rounds_ct)::integer                         AS rounds_ct,
