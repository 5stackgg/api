// Reference implementation converted to TypeScript
// Functions kept exactly as-is, only removed server.listen and added exports
...
export const match_broadcasts: { [key: string]: any[] } = {};
...
export function getTokenRedirect(): string | null {
  return _token_redirect_for_example;
}

export function setTokenRedirect(value: string | null): void {
  _token_redirect_for_example = value;
}

// For backward compatibility, export a getter/setter object
export const token_redirect_for_example = {
  get value() {
    return _token_redirect_for_example;
  },
...
export function respondSimpleError(
  uri: string,
...
export function checkFragmentCdnDelayElapsed(fragmentRec: any): boolean {
...
export function isSyncReady(f: any): boolean {
  return (
    f != null &&
    typeof f === "object" &&
    f.full != null &&
...
export function getMatchBroadcastEndTick(broadcasted_match: any[]): number {
...
export function respondMatchBroadcastSync(
...
export function processRequestUnprotected(
  request: IncomingMessage,
  response: ServerResponse,
) {
